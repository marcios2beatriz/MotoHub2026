...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col font-sans relative">
      ...
      <header className="bg-white/95 backdrop-blur-md border-b border-slate-200 sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center space-x-3 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <img src="/logo.png" alt="MotoHub Logo" className="h-11 w-11 object-contain rounded-xl shadow-sm" />
            <div>
              <span className="text-xl font-black text-slate-900 tracking-tight flex items-center gap-1.5">
                MotoHub <span className="text-indigo-600 text-[10px] px-2 py-0.5 rounded-full bg-indigo-50 border border-indigo-200 uppercase font-mono font-bold">Delivery</span>
              </span>
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            <button 
              ...
              className="flex items-center space-x-1.5 text-slate-700 hover:text-indigo-600 hover:bg-slate-100 px-3.5 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all"
            >
            ...
            <button 
              ...
              className="hidden sm:flex items-center space-x-1.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-extrabold transition-all border border-emerald-200 shadow-sm"
            >
            ...
            <button 
              ...
              className="flex items-center space-x-1.5 bg-indigo-600 hover:bg-indigo-700 text-white px-4 sm:px-5 py-2.5 rounded-xl text-xs sm:text-sm font-extrabold transition-all shadow-md shadow-indigo-600/20"
            >
      ...
      {/* Hero Section */}
      <section className="relative pt-12 sm:pt-16 pb-16 sm:pb-24 bg-gradient-to-b from-white via-slate-50 to-slate-100 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          
          {/* Lado Esquerdo */}
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-bold bg-indigo-50 text-indigo-700 border border-indigo-200 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-3.5 pt-2">
              <button 
                onClick={() => setShowRegisterModal(true)}
                className="flex items-center justify-center space-x-2 bg-indigo-600 hover:bg-indigo-700 text-white px-7 py-3.5 rounded-2xl font-black text-sm transition-all shadow-lg shadow-indigo-600/25 hover:scale-[1.02]"
              >
              ...
              <button 
                onClick={() => setShowEstModal(true)}
                className="flex items-center justify-center space-x-2 bg-white hover:bg-slate-50 text-slate-800 px-6 py-3.5 rounded-2xl font-bold text-sm transition-all border border-slate-300 shadow-sm"
              >
            ...
            <div className="relative w-full max-w-md bg-white border border-slate-200 rounded-3xl p-6 shadow-xl space-y-4">
              ...
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <div className="flex items-center space-x-2">
                  <img src="/logo.png" alt="MotoHub" className="h-7 w-7 object-contain" />
              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                <div className="p-2.5 bg-slate-50 border border-slate-200 rounded-xl flex items-center gap-2">
                  ...
                  <span className="text-[11px] font-bold text-slate-700">Roteirização Menor Rota</span>
                </div>
                <div className="p-2.5 bg-slate-50 border border-slate-200 rounded-xl flex items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-3">
            ...
            <div className="flex justify-center pt-2">
              <div className="bg-white p-1.5 rounded-2xl border border-slate-200 flex items-center space-x-1 shadow-sm">
                <button
          ...
          {activeFeatureTab === 'establishments' ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white border border-slate-200 hover:border-indigo-300 p-6 rounded-3xl space-y-3 transition-all shadow-sm">
              ...
              <div className="bg-white border border-slate-200 hover:border-emerald-300 p-6 rounded-3xl space-y-3 transition-all shadow-sm">
              ...
              <div className="bg-white border border-slate-200 hover:border-purple-300 p-6 rounded-3xl space-y-3 transition-all shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white border border-slate-200 hover:border-amber-300 p-6 rounded-3xl space-y-3 transition-all shadow-sm">
      ...
      <section className="bg-white border-y border-slate-200 py-14 sm:py-16">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-5">
          ...
          <button
            ...
            className="inline-flex items-center space-x-2 bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-3.5 rounded-2xl font-black text-sm transition-all shadow-lg shadow-emerald-600/25 hover:scale-105"
          >
      ...
      <footer className="bg-slate-900 text-slate-400 py-8 mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
          <div className="flex items-center space-x-2.5">
            <img src="/logo.png" alt="MotoHub Logo" className="h-6 w-6 object-contain brightness-0 invert" />
      ...
      <button
        onClick={handleWhatsAppContact}
        className="fixed bottom-6 right-6 bg-emerald-500 hover:bg-emerald-600 text-white p-4 rounded-full shadow-2xl transition-all hover:scale-110 z-50 flex items-center justify-center border-2 border-white"
      ...
      {showRegisterModal && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl border border-slate-200 max-h-[95vh] overflow-y-auto">
            ...
            {success ? (
              ...
              <form onSubmit={handleRegister} className="space-y-3.5 text-xs">
                <div>
                  <label className="block font-bold text-slate-600 uppercase mb-1">Nome Completo</label>
                  <input
                    type="text"
                    required
                    ...
                    className="w-full px-3.5 py-2.5 border border-slate-300 rounded-xl text-slate-900 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                  />
                </div>
                <div>
                  <label className="block font-bold text-slate-600 uppercase mb-1">CPF</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block font-bold text-slate-600 uppercase mb-1">WhatsApp / Telefone</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block font-bold text-slate-600 uppercase mb-1">E-mail</label>
                  <input
                    type="email"
                    required
                ...
                <div>
                  <label className="block font-bold text-slate-600 uppercase mb-1">Senha Inicial</label>
                  <input
                    type="password"
                    required
                    placeholder="••••••••"
          ...
          <div className="bg-white rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl border border-slate-200 max-h-[95vh] overflow-y-auto">
            ...
            {success ? (
              ...
              <form onSubmit={handleEstRegister} className="space-y-3.5 text-xs">
                <div>
                  <label className="block font-bold text-slate-600 uppercase mb-1">Nome do Estabelecimento</label>
                  <input
                    type="text"
                    required
                    ...
                    className="w-full px-3.5 py-2 border border-slate-300 rounded-xl text-slate-900 focus:outline-none focus:ring-1 focus:ring-emerald-500"
                  />
                </div>
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label className="block font-bold text-slate-600 uppercase mb-1">Nome do Gerente</label>
                    <input
                      type="text"
                      required
                  ...
                  <div>
                    <label className="block font-bold text-slate-600 uppercase mb-1">Telefone WhatsApp</label>
                    <input
                      type="text"
                      required
                      placeholder="(83) 99999-9999"
                ...
                <div className="border-t border-slate-100 pt-3 space-y-2">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div className="col-span-2">
                      <label className="block font-bold text-slate-600 uppercase mb-1">CEP</label>
                      <input
                        type="text"
                        required
                    ...
                    <div>
                      <label className="block font-bold text-slate-600 uppercase mb-1">Número</label>
                      <input
                        type="text"
                        required
                        placeholder="100"
                  ...
                  <div>
                    <label className="block font-bold text-slate-600 uppercase mb-1">Rua / Bairro</label>
                    <input
                      type="text"
                      required
                ...
                <div className="border-t border-slate-100 pt-3 space-y-2">
                  ...
                  <div>
                    <label className="block font-bold text-slate-600 uppercase mb-1">E-mail de Acesso</label>
                    <input
                      type="email"
                      required
                      ...
                      className="w-full px-3.5 py-2 border border-slate-300 rounded-xl text-slate-900 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                    />
                  </div>
                  <div>
                    <label className="block font-bold text-slate-600 uppercase mb-1">Senha</label>
                    <input
                      type="password"
                      required
                      placeholder="••••••••"
