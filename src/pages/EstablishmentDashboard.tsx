...
export default function EstablishmentDashboard() {
  ...
  const filteredDeliveries = deliveries
    .filter(d => {
      ...
      } else if (paymentFilter === 'pix')<dyad-write path="src/pages/EstablishmentDashboard.tsx" description="Finalizar atualização do painel do Estabelecimento com o card das 5 métricas de repasse">
"use client";
