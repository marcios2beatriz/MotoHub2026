                          ...
                          <div className="flex items-center justify-between gap-2">
                            <div className="min-w-0 space-y-1">
                              <div className="flex items-center gap-1.5 flex-wrap">
                                ...
                                {repeatCount > 1 && (
                                  <span className="bg-amber-500 text-slate-950 text-[9px] font-black px-2 py-0.5 rounded-full flex items-center gap-0.5 shadow-xs border border-amber-600">
                              ...
                              <div key={del.id} className="py-2 flex items-center justify-between">
                                <div className="space-y-0.5">
                                  ...
                                  {Number(del.additionalValue || 0) > 0 && (
                                    <<dyad-write path="src/pages/EstablishmentDashboard.tsx" description="Finalizar implementação do filtro de corridas com mesmo número e ordenação no Estabelecimento">
"use client";
