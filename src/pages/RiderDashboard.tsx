...
export default function RiderDashboard() {
  ...
  const earningsDeliveriesCount = filteredEarningsDeliveries.<dyad-write path="src/pages/RiderDashboard.tsx" description="Finalização completa do componente RiderDashboard com todas as abas, tabelas e modais">
"use client";
